...
if __name__ == '__main__':
    """
    Personalized version based on Andrew Grant's (Andrew6rant) original 2022-2025 script
    """
    ...
    # Birthday: 9 May 2002 (adjust below if you meant 5 September 2002 instead)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2002, 5, 9))
